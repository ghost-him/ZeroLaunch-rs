...
pub fn test_search_algorithm<R: Runtime>(
    ...
    Ok(program_manager.test_search_algorithm(&search_text))
}
...
pub fn test_search_algorithm_time<R: Runtime>(
    ...
    let program_manager = state.get_program_manager().unwrap();
    Ok(program_manager.test_search_algorithm_time())
}
...
pub fn test_index_app_time<R: Runtime>(
    ...
    let program_manager = state.get_program_manager().unwrap();
    let time = program_manager.get_program_loader_loading_time();
    Ok(time)
}
...
pub fn get_search_keys<R: Runtime>(
    ...
    let program_manager = state.get_program_manager().unwrap();
    let search_keywords = program_manager.get_search_keywords(&show_name);
    Ok(search_keywords)
}
