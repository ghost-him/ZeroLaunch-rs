<template>
  <div class="launcher-container" @keydown="handleKeyDown" @keyup="handleKeyUp" @blur="handleBlur" tabindex="0" :style="[program_backgroundStyle,
    ...
    <Footer
      :uiConfig="ui_config"
      :appConfig="app_config"
      :statusText="is_refreshing_dataset ? t('app.refreshing_dataset') : (is_loading_icons ? t('app.loading_icons') : (status_tip || right_tips))"
    />
