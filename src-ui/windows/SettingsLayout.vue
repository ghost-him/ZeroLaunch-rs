<template>
    <div class="settings-layout">
        <div class="sidebar">
            ...
            <el-scrollbar>
                <el-menu :default-active="activeMenu" class="settings-menu" router :collapse="false">
                    ...
                    <el-sub-menu index="/setting_window/appearance">
                        ...
                        <el-menu-item index="/setting_window/appearance/search">{{
                            t('ui_config.search_and_result_settings') }}</el-menu-item>
                        <el-menu-item index="/setting_window/appearance/background">{{
                            t('ui_config.background_image_settings')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/appearance/window">{{ t('ui_config.window_settings')
                            }}</el-menu-item>
                    </el-sub-menu>
                    ...
                    <el-sub-menu index="/setting_window/programs">
                        ...
                        <el-menu-item index="/setting_window/programs/paths">{{ t('program_index.set_search_path')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/programs/blocklist">{{ t('program_index.set_blocked_paths')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/programs/keywords">{{ t('program_index.set_fixed_offset')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/programs/aliases">{{ t('program_index.setting_alias')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/programs/advanced">{{ t('program_index.extra_settings')
                            }}</el-menu-item>
                    </el-sub-menu>
                    ...
                    <el-sub-menu index="/setting_window/search">
                        ...
                        <el-menu-item index="/setting_window/search/web">{{ t('settings.custom_web_search')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/search/custom">{{ t('settings.custom_command_search')
                            }}</el-menu-item>
                        <el-menu-item index="/setting_window/search/builtin">{{ t('settings.builtin_command_settings')
                            }}</el-menu-item>
                    </el-sub-menu>
