<template>
    <div class="everything-panel" :style="{
        ...
        <div v-if="results.length === 0 && !isSearching" class="no-results" :style="{
        ...
        <div v-else class="results-list" ref="resultsListRef">
            <div v-for="(item, index) in results" :key="item[0]" class="result-item"
                :class="{ 'selected': selectedIndex === index }" @click="handleItemClick(index)" :style="{
                ...
                <div class="icon" :style="{
                    ...
                    <img src="/tauri.svg" class="custom-image" alt="icon">
                </div>
                <div class="item-info">
