<template>
  <div class="settings-page">
    <div class="header">
      ...
      <p class="description">
        {{ t('settings.builtin_command_description') }}
      </p>
    </div>
    ...
    <div class="content-container">
      ...
      >
        ...
        <el-table-column
          :label="t('settings.builtin_command_display_name')"
          width="150"
        >
          <template #default="{ row }">
        ...
        <el-table-column
          :label="t('settings.builtin_command_keywords')"
          min-width="300"
        >
          <template #default="{ row }">
            <el-tag
        ...
        <el-table-column
          :label="t('settings.builtin_command_enabled')"
          width="100"
          align="center"
        >
          <template #default="{ row }">
