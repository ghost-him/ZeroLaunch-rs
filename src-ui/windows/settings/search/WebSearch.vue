<template>
    <div class="settings-page">
        <h2 class="page-title">{{ t('settings.custom_web_search') }}</h2>
        <div class="content-container">
            <el-button class="add-btn" @click="addIndexWebPage">
                <el-icon><Plus /></el-icon> {{ t('settings.add_item') }}
            </el-button>
            <el-table :data="index_web_pages" stripe style="width: 100%; margin-top: 10px;">
                ...
                <el-table-column :label="t('settings.target_website_address')" show-overflow-tooltip>
                    <template #default="scope">
                        <div style="display: flex; gap: 5px;">
                            <el-select :model-value="getProtocol(scope.$index)" size="small" style="width: 90px;"
